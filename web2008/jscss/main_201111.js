...
document.writeln("      <li id=\"m_service\"><strong><a href=\"http://service.qq.com/category/qqtang.html\" title=\"腾讯客服\">腾讯客服<\/a><\/strong><span>");
document.writeln("        <ul>");
document.writeln("          <li><a href=\"http://service.qq.com/category/qqtang.html\" title=\"客户服务\">客户服务<\/a><\/li>");
...
//登录	
document.writeln("<script language=\"javascript\" src=\"http://ossweb-img.qq.com/images/js/login/loginmanagerv2_min.js\"><\/script>")
function qqt_login()
{
document.writeln("<div class=\"urs\"><div id=\"logined\" style=\"display:none; padding-left:5px;\"><a href=\"javascript:LoginManager.logout();\" style=\"cursor:hand; background:url(http://ossweb-img.qq.com/images/qqtang/web08/login_03.jpg) no-repeat center -5px;\" class=\"hid\">注销</a></div><div id=\"unlogin\" style=\"display:block\"><a href=\"javascript:LoginManager.login();\" style=\"cursor:hand; height:50px;\" class=\"hid\">用户登录</a></div><script type=\"text/javascript\">LoginManager.checkLogin();</script></div>");
...
document.writeln("<p class=\"license2\"><a style=\"padding-left:13px\" href=\"http:\/\/game.qq.com\/culture.htm\" target=\"_blank\">粤网文[2017]6138-1456号<\/a><\/p>");
...
document.writeln("<\/tr>");
document.writeln("<\/table>")
}/*  |xGv00|f4424c4e8fa0203715290151319a5ea0 */